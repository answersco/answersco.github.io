...
-FAP with fibromatosis (in retroperitoneum, locally destructive) and osteomas (benign tumor in skull). will present on UGI with multiple hyperplastic, pre-malignant polyps. familial (FAP)
...
Autosomal dominant- multiple osteomas, intestinal polyps, soft tissue desmoid dumors

FAP + osteomas, desmoids, papillary thyroid. If osteoma of the jaw, think Gardners
